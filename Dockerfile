...
RUN mkdir -p ./renew /tmp/renew-download && \
    ...
    unzip ${RENEW_DOWNLOAD_TARGET} -d /tmp/renew-download && \
...
ENV RENEW_PROJ_DB_PATH=${DATA_ROOT_PATH}/renew_proj.db
...
ENV SIM_RENEW_PLUGINS=""
ENV RENEW_TEXT_MEASURE=/text_metrics/TextMeasure.java
ENV SIM_XVBF_DISPLAY=":23"
ENV PHX_HOST="localhost"
ENV PORT="4000"
ENV RENEW_EMAIL_WHITELIST="^$"
ENV RENEW_MAILER_SMTP_HOST="localhost"
ENV RENEW_MAILER_SMTP_USER="mailer"
ENV RENEW_MAILER_SMTP_PASSWORD=""
ENV RENEW_MAILER_SMTP_PORT="587"
ENV RENEW_MAILER_SMTP_RETRIES="1"
