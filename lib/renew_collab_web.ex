defmodule RenewCollabWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.svg robots.txt favicon.ico)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: RenewCollabWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: RenewCollabWeb.static_paths()
    end
  end
