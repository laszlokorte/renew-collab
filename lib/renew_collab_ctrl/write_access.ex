defmodule RenewCollabCtrl.WriteAccess do
  ...
  def can(%{id: account_id}, %Actions.SimulationListBreakpoints{simulation_id: sim_id}),
    do: can_write(account_id, :simulation, sim_id)

  def can(%{id: account_id}, %Actions.SimulationSetTransitionBreakpoint{simulation_id: sim_id}),
    do: can_write(account_id, :simulation, sim_id)

  def can(%{id: account_id}, %Actions.SimulationClearTransitionBreakpoint{simulation_id: sim_id}),
    do: can_write(account_id, :simulation, sim_id)

  def can(%{id: account_id}, %Actions.SimulationClearBreakpoints{simulation_id: sim_id}),
    do: can_write(account_id, :simulation, sim_id)
