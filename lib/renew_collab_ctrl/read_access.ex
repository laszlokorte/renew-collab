defmodule RenewCollabCtrl.ReadAccess do
  ...
  def can(%{id: _account_id, is_admin: true}, %Views.ProjectRunningSimulationIds{
        project_id: _proj_id
      }),
      do: true

  def can(%{id: account_id}, %Views.ProjectRunningSimulationIds{
        project_id: proj_id
      }),
      do: can_read(account_id, :project, proj_id)

  def can(%{id: _account_id, is_admin: true}, %Views.SimulationIsActive{project_id: _proj_id}),
    do: true
  ...
  def can(%{id: _account_id, is_admin: true}, %Views.ShadowNetSystem{
  ...
  def can(%{id: _account_id, is_admin: true}, %Views.SimulationWithState{simulation_id: _sim_id}),
    do: true
  ...
  def can(%{id: _account_id, is_admin: true}, %Views.ShadowNetSystemSimulations{
        shadow_net_system_id: _sns_id
      }),
      do: true
