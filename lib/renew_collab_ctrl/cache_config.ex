defmodule RenewCollabCtrl.CacheConfig do
  ...
  def tags_for_action(%Actions.DocumentEditLayerTextType{}, _result), do: []
  ...
  def tags_for_action(%Actions.SimulationNetStep{}, _result), do: []
  def tags_for_action(%Actions.SimulationConsoleCommand{}, _result), do: []
  def tags_for_action(%Actions.SimulationTransitionBindings{}, _result), do: []
  def tags_for_action(%Actions.SimulationFireTransition{}, _result), do: []
