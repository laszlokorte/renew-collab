defmodule RenewCollabWeb.StateChannel do
  ...
  """
  @callback authorize(channel :: binary(), payload :: term(), socket :: Phoenix.Socket.t()) ::
              {:ok, socket :: Phoenix.Socket.t()} | {:error, binary()}
  ...
  @callback handle_event(
              ...
              {:reply, reply :: %LiveState.Event{} | list(%LiveState.Event{}), new_state :: map(),
               Phoenix.Socket.t()}
              | {:noreply, new_state :: map(), Phoenix.Socket.t()}
              | :silent
              | :ack
  ...
  defmacro __using__(opts) do
    quote generated: true do
      ...
      @dialyzer {:nowarn_function, build_new_state_message: 2}
      @dialyzer {:nowarn_function, build_update_message: 3}
