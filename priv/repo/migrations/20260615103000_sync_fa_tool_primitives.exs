defmodule RenewCollab.Repo.Migrations.SyncFaToolPrimitives do
  use Ecto.Migration
  ...
  def up do
    ...
    |> Enum.find(fn group -> group.name == "FA" end)
    |> sync_fa_group()
  end
  ...
  defp sync_fa_group(nil), do: :ok

  defp sync_fa_group(group) do
